...
const SIDEBAR_MENUS = [
  ...
  { slug: 'documents_noc', label: 'Documents — NOC', icon: FolderOpen, group: 'documents', alwaysVisible: false },
  { slug: 'documents_employee_docs', label: 'Documents — Employee Documents', icon: FolderOpen, group: 'documents', alwaysVisible: false },
  { slug: 'documents_delete', label: 'Documents — Delete', icon: FolderOpen, group: 'documents', alwaysVisible: false },
