  ...
  try {
    ...
    const data: Record<string, unknown> = {
      ...
      currentTotalWorkingHours:
        body.currentTotalWorkingHours != null
          ? Math.max(0, parseFloat(body.currentTotalWorkingHours) || 0)
          : 0,
    };

    // Sync currentSiteId FK from the site name when provided
    if (body.currentSite) {
